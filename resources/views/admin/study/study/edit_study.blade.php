                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control width" name="pre_housing" id="pre_housing" placeholder="Pre Housing" autocomplete="off" value="{{ $study->pre_housing }}" required/>
                            </div>

                            <div class="form-group mb-3">
                                <label>Post Housing (In Hours)<span class="mandatory">*</span></label>
                                <input type="text" class="form-control width" name="post_housing" id="post_housing" placeholder="Post Housing" autocomplete="off" value="{{ $study->post_housing }}" required/>
                            </div>
