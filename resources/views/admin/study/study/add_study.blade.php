                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control width" name="washout_period" id="washout_period" placeholder="Washout Period" autocomplete="off" required/>
                            </div>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <select class="form-control select2 selectClinicalWordLocation" name="clinical_word_location" id="clinical_word_location" data-placeholder="Select Clinical Ward Location" required>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control" name="additional_requirement" id="additional_requirement" placeholder="Additional Requirement" autocomplete="off" required/>
                            </div>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <textarea class="form-control" name="study_text" id="study_text" placeholder="Study Title / Protocol Title" required></textarea>
                            </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control width" name="pre_housing" id="pre_housing" placeholder="Pre Housing" autocomplete="off" required/>
                            </div>

                            <div class="form-group mb-3">
                                <label>Post Housing (In Hours)<span class="mandatory">*</span></label>
                                <input type="text" class="form-control width" name="post_housing" id="post_housing" placeholder="Post Housing" autocomplete="off" required/>
                            </div>
