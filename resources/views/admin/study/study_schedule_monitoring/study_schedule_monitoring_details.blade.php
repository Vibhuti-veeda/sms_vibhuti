                                                                                           ...
                                                                                           <!--  @if(Auth::guard('admin')->user()->role_id == 2 || Auth::guard('admin')->user()->role_id == 1)
                                                                                            ...
                                                                                            @endif -->
                                                                                                ...
                                                                                                @else
                                                                                                    @if($asv->actual_start_date == '')
                                                                                                        <td>
                                                                                                            <a class="btn btn-primary btn-sm waves-effect waves-light saveStartDate saveStart_{{$asv->id}}" data-id="{{ $asv->id }}" href="Javascript:void(0);" role="button" title="Save" data-toggle="modal" data-target="#openStartDateModal">
                                                                                                                <i class="bx bx-save"></i>
                                                                                                            </a>
                                                                                                        </td>
                                                                                                    @else
