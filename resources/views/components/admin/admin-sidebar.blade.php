                ...
                @if(in_array('study',$module))
                    <li>
                        ...
                        <ul class="sub-menu" aria-expanded="false">
                            ...
                            @endif
                            @if(in_array('department-schedule-tracking',$module))
                                <li>
                                    <a href="{{ route('admin.departmentScheduleTrackingList') }}">
                                        Dep. Schedule Tracking
                                    </a>
                                </li>
                            @endif
                            @if(in_array('department-activity-tracking',$module))
                                <li>
                                    <a href="{{ route('admin.departmentActivityTrackingList') }}">
                                        Dep. Activity Tracking
                                    </a>
                                </li>
                            @endif
                        </ul>
