<?php
    ...
    Route::group(['prefix' => 'study-schedule'], function () {
        ...
        Route::get('/view/get-delay-activity-records', 'Study\StudyScheduleController@getDelayActivityRecords')->name('admin.getDelayActivityRecords');
        Route::get('/view/get-upcoming-activity-records', 'Study\StudyScheduleController@getUpComingActivityRecords')->name('admin.getUpComingActivityRecords');
    });
