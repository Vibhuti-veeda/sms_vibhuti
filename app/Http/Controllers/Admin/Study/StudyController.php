...
class StudyController extends GlobalController
{
    ...
    **/
    public function addStudy(){
        ...
        return view('admin.study.study.add_study', compact('sponsors', 'scope', 'studyDesign', 'studySubType', 'subjectType', 'blindingStatus', 'crLocation', 'regulatorySubmission', 'studyType', 'complexity', 'studyCondition', 'priority', 'brLocation', 'principle', 'bioanalytical', 'projectManager', 'specialNotes'));
    }
    ...
    **/
    public function selectDrugDetails(Request $request){
        ...
        $html = '<tbody class="removeRow"><tr><td>';

        $html .= '<select class="form-select select_drug" name="drug['.$request->id.'][drug]" id="drug_details" data-placeholder="Select Drug" required data-msg="Please select drug"><option value="">Select Drug</option>';
        ...
        $html .= '</select></td><td><select class="form-select select_dosage_form" id="drug_dosage_form" name="drug['.$request->id.'][dosage_form]" data-placeholder="Select Dosage Form" required data-msg="Please select dosage form"><option value="">Select Dosage Form</option>';
        ...
        $html .= '</select></td><td><input type="text" id="drug_strength" class="form-control" name="drug['.$request->id.'][dosage]" placeholder="Dose" autocomplete="off" data-msg="Please enter dose" required/></td><td><input type="text" id="drug_strength" class="form-control" name="drug['.$request->id.'][drug_strength]" placeholder="Drug Strength"  autocomplete="off"/></td><td><select class="form-select selectUOM" name="drug['.$request->id.'][uom]" data-placeholder="Select UOM" id="drug_strength" data-msg="Please select uom" required><option value="">Select UOM</option>';
        ...
        $html .= '</select></td><td><select class="form-select selectType" name="drug['.$request->id.'][type]" id="drug_reference" data-placeholder="Select Type" data-msg="Please select drug reference" required><option value="">Select Type</option><option value="TEST">Test</option><option value="REFERENCE">Reference</option>';

        $html .= '</select></td><td><input type="text" class="form-control" name="drug['.$request->id.'][manufacture]" id="manufacture" placeholder="Manufacture / Distribution By" autocomplete="off" data-msg="Please enter manufacture" required/></td><br><td><a href="javascript:void(0);" class="text-danger remove" data-toggle="tooltip" data-id="'.$request->id.'" data-placement="top" title="" data-original-title="Remove"><i class="mdi mdi-close font-size-20"></i></a></td></tr></tbody>';
