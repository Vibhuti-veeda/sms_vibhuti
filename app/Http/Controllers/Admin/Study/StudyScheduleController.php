...
class StudyScheduleController extends GlobalController
{
    ...
    **/
    ...
    public function getUpComingActivityRecords(){
        ...
        $responsibilityIds = [7, 8, 9, 11, 12, 13, 15];
        $upComingActivities = StudySchedule::select('id', 'study_id', 'activity_id', 'activity_name', 'activity_status', 'activity_type', 'scheduled_start_date', 'scheduled_end_date','responsibility_id')
        ...
        if(!is_null($responsibilityIds)){
            foreach ($responsibilityIds as $rbik => $rbiv){
                ($upComingActivity[$rbiv] = $upComingActivities->where('responsibility_id', $rbiv));
            }
        }

        return view('admin.mail.upcoming_activities_list',compact('upComingActivity','responsibilityIds')); 
    }
